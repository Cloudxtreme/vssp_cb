...
modules.UserBoardHandler.prototype.removeScheduledServiceRequest = function(videoRecordServiceID, videoBatchID, id) {
	...
	*/
	var conn = new modules.BoardConnectionHandler;
	conn.sendPostData('/board/removeScheduledVideoRecordRequest', 'record_service_id=' + videoRecordServiceID + '&video_batch_id=' + videoBatchID + '&auth_id=' + id, 'RemoveScheduledServiceRequestSignal');			
